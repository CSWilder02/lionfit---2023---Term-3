...
function Login() {
    ...
    return (
        <div style={{ backgroundImage: `url(${Back})`, backgroundSize: '100%', backgroundColor: 'black', position: 'relative', height: '723px' }}>
            <div style={{width: '1481px'}} className={`container5 ${isSignUpActive ? 'right-panel-active' : ''}`} id="container5">
